...
constexpr auto qt_meta_stringdata_CLASSAddressWidgetENDCLASS = QtMocHelpers::stringData(
    "AddressWidget",
    "addressSubmitted",
    "",
...
void AddressWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AddressWidget::*)();
            if (_t _q_method = &AddressWidget::addressSubmitted; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
